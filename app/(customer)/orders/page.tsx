...
import { Package, Clock, ChevronRight, RotateCcw, Check } from 'lucide-react'

export const metadata = {
  title: 'Orders — Som Tam Thai',
}
...
export default function OrdersPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 pb-28 md:pb-10 space-y-8">
      ...
      <div>
        <h2 className="font-lora text-xl font-bold text-gray-900 mb-4">Order History</h2>
