...
export default function AccountPage() {
  ...
  const [phone, setPhone] = useState('+960 789 2616')
    ...
    <div className="max-w-3xl mx-auto px-4 py-6 pb-28 md:pb-10 space-y-6">
      ...
      {upcoming && (
        <div className="bg-brand-green text-white rounded-2xl p-5 flex items-start justify-between gap-4">
          <div>
            <p className="text-xs text-white/60 uppercase tracking-wider font-medium mb-1">Upcoming Reservation</p>
              ...
              >
                ...
                <div className="flex-grow min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">{o.status}</span>
                  </div>
                ...
                <div className="text-right flex-shrink-0">
                  ...
                  <Link href="/" className="text-xs text-brand-terracotta hover:underline flex items-center gap-0.5 justify-end mt-1">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
        <button className="w-full p-4 flex items-center gap-3 text-red-500 hover:bg-red-50 transition rounded-xl">
